...
render()
{
  ...
  return (
    ...
    actions={[<button><Icon type="heart" theme={this.state.theme} style={{fontSize:"20px", color:"#ff0000"}} onClick={this.changeIcon} /></button>, <button><Icon type="edit"  style={{fontSize:"20px"}} onClick={this.showModal}/></button>, <button><Icon type="delete" theme="filled" style={{fontSize:"20px"}} onClick={()=>this.props.removeItem(this.state.id)}/></button> ]}
  >
